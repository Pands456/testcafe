...
test('Funds Collection Creation_Test_03', async t => {
  ...
  await Function_Utility.AssureClaims_Funds_Transaction_Creation("1","NA",CollectionTransactionDate,"NA","NA",StrSubBankAccountName,data.PayeeType,data.LastName,data.ReserveType,data.TransactionType,"50")
  ...
  test('Funds Transaction Creation_Test_04', async t => {
    var checknumberVoidOrphan = faker.random.number({min: 10000, max: 99999});
      var CollectionTransactionDate =await Generic_Utility.AssureClaims_FuturePastDateInfo_Utility(-1,-1,0, "MM/DD/YYYY")
      var CheckDate =await Generic_Utility.AssureClaims_FuturePastDateInfo_Utility(-1,-1,0, "MM/DD/YYYY")
  ...
  await Function_Utility.AssureClaims_Funds_Transaction_Creation("NA","NA",CollectionTransactionDate,"NA","NA",StrSubBankAccountName,data.PayeeType,data.LastName,data.ReserveType,data.TransactionType,"10")
...
test('Funds Transaction Creation_Test_05', async t => {
    var checknumberVoidOrphan = faker.random.number({min: 10000, max: 99999});
  ...
  console.log("AssureClaims_Funds_Transaction_Creation Function is Called To Create Payment ".yellow);
  await Function_Utility.AssureClaims_Funds_Transaction_Creation("NA","NA",CollectionTransactionDate,"NA","NA",StrSubBankAccountName1,data.PayeeType,data.LastName,data.ReserveType,data.TransactionType,"75")
  console.log("Funds Transaction is Created");
  //New Collection Is Created
  await Verify_Utility.AssureClaims_VerifyElementValue_Utility(Payment_POM.AssureClaims_PaymentCollection_CheckStatus,data.CheckStatusRReleased, "CheckStatus TextBox");
  //Orphan Transaction Status Released Verified
