...
const DataIUT_ORA = require('../DataFiles/DataIUT_ORA.json');
...
DataIUT_ORA.forEach(data => {
    ...
    test('AssureClaims_EnityCreation_Test_01', async t => {
       ...
       //Entity Employee is created
        ...
        var EmployeNumber = await Maint_Utility.AssureClaims_MaintenanceAddNewEntity_Eron_Utility("Employee", data.Department, "NA", "NA");
        ...
        await Nav_Utility.AssureClaims_ElementClick_Utility(Entity_POM.AssureClaims_Enity_Employee_Btn, "Med-Staff Button On Toolbar ");
        var MedStaffNumber = await Maint_Utility.AssureClaims_MaintenanceAddNewEntity_Eron_Utility("Medical Staff", "NA", "NA", "NA");
        ...
        await t.wait(4000);
        await Maint_Utility.AssureClaims_MaintenanceAddNewEntity_Eron_Utility("Physician", "NA", "NA", "NA");
        await t.switchToMainWindow();
        await Nav_Utility.AssureClaims_ElementClick_Utility(Home_POM.AssureClaims_GenericBtn_Back, "Back Button")
        await t.wait(2000);
        await Nav_Utility.AssureClaims_ElementClick_Utility(Home_POM.AssureClaims_DefaultView_Img_Reload, "Reload Button ");
